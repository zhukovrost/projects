...
<body>
	...
	<nav class="users-search-nav">
		<div class="container">
            ...
            <?php if ($subs){ ?>
                <a class="button-text users-search-nav__item" href="search_users.php?subs=0"><p>Все</p><img src="../../assets/img/arrow_white.svg" alt=""></a>
            <?php } else { ?>
                <a class="button-text users-search-nav__item" href="search_users.php?subs=1"><p>Подписки</p><img src="../../assets/img/arrow_white.svg" alt=""></a>
            <?php } ?>
			<!-- users search -->
