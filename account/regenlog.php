          ...
          if ($reg_result = $conn->query($reg_sql)) {
            ...
            if ($rowsCount == 0) {
              if (isset($_POST['reg_thirdname'])) {
                ...
                $reg_sql2 = "INSERT INTO users(login, password, name, surname, thirdname, email, date_of_birth, sex, weight, height, program, program_duration) VALUES('" . $reg_login . "', '" . $reg_password . "', '" . $reg_name . "', '" . $reg_surname . "', '" . $reg_thirdname . "', '" . $reg_email ."', '".$reg_date_of_birth."', '".$reg_sex."', 0, 0, '".json_encode([], JSON_UNESCAPED_UNICODE)."', 0)";
              } else {
                $reg_sql2 = "INSERT INTO users(login, password, name, surname, thirdname, email, date_of_birth, sex, weight, height, program, program_duration) VALUES('" . $reg_login . "', '" . $reg_password . "', '" . $reg_name . "', '" . $reg_surname . "', null, '" . $reg_email . "', '".$reg_date_of_birth."', '".$reg_sex."', 0, 0, '".json_encode([], JSON_UNESCAPED_UNICODE)."', 0)";
              }
