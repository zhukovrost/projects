...
<nav class="exercises-nav">
    <div class="container">
        ...
        <?php if ($my) { ?>
            <a class="button-text exercises-nav__item" href="c_control_exercises.php?my=0&for=<?php echo $user_id; ?>">Все <img src="../../assets/img/arrow_white.svg" alt=""></a>
        <?php } else { ?>
            <a class="button-text exercises-nav__item" href="c_control_exercises.php?my=1&for=<?php echo $user_id; ?>">Мои <img src="../../assets/img/arrow_white.svg" alt=""></a>
        <?php } ?>
        <!-- Main search -->
