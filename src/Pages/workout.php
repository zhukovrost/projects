...
<body>
        ...
        <div class="container">
            ...
            <section class="workout-other">
                ...
                <section class="workout-other__buttons">
                    <a class="button-text workout-other__button" href="my_program.php"><p>Моя программа</p> <img src="../../assets/img/my_programm.svg" alt=""></a>
                </section>
            </section>
        </div>
    ...
    <?php include BASE_PATH . "/templates/footer.html"; // include footer template ?>
