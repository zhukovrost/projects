          ...
          if ($reg_result = $conn->query($reg_sql)) {
            ...
            if ($rowsCount == 0) {
              if (isset($_POST['reg_thirdname'])) {
                ...
                $reg_sql2 = "INSERT INTO users(login, password, name, surname, thirdname, email) VALUES('".$reg_login."', '".md5($reg_password)."', '".$reg_name."', '".$reg_surname."', '".$reg_thirdname."', '".$reg_email."')";
              } else {
                $reg_sql2 = "INSERT INTO users(login, password, name, surname, email) VALUES('".$reg_login."', '".md5($reg_password)."', '".$reg_name."', '".$reg_surname."', '".$reg_email."')";
              }
