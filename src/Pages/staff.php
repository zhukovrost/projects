				...
				<section class="staff-block__header">
					...
					<section class="staff-block__info">
						<div class="staff-block__name">
							...
							<a class="staff-block__profile-link" href="profile.php?user=<?php echo $user_data->coach->get_id(); // link to coach's profile ?>"><img src="../../assets/img/profile_black.svg" alt=""></a>
						</div>
						<div class="staff-block__buttons">
                            <?php if ($user_data->coach->vk != NULL){ // Display VK Contact Button if available ?>
                            <a href="<?php echo $user_data->coach->vk; ?>" class="staff-block__button staff-block__button--img"><img src="../../assets/img/vk.svg" alt=""></a>
                            <?php }if ($user_data->coach->tg != NULL){ // Display Telegram Contact Button if available ?>
							<a href="<?php echo $user_data->coach->tg; ?>" class="staff-block__button staff-block__button--img"><img src="../../assets/img/tg.svg" alt=""></a>
                            <?php } ?>
							<a href="../Actions/delete_coach.php?id=<?php echo $user_data->coach->get_id(); // link to delite coach ?>" class="button-text staff-block__button staff-block__button--delite"><p>Удалить</p> <img src="../../assets/img/delete.svg" alt=""></a>
						</div>
					</section>
				</section>
				...
				<section class="staff-block__header">
					...
					<section class="staff-block__info">
						<div class="staff-block__name">
							...
							<a class="staff-block__profile-link" href="profile.php?user=<?php echo $user_data->doctor->get_id(); ?>"><img src="../../assets/img/profile_black.svg" alt=""></a>
						</div>
						<div class="staff-block__buttons">	
                            <?php if ($user_data->doctor->vk != NULL){ // Display VK Contact Button if available ?>
                                <a href="<?php echo $user_data->doctor->vk; ?>" class="staff-block__button staff-block__button--img"><img src="../../assets/img/vk.svg" alt=""></a>
                            <?php }if ($user_data->doctor->tg != NULL){ // Display Telegram Contact Button if available ?>
                                <a href="<?php echo $user_data->doctor->tg; ?>" class="staff-block__button staff-block__button--img"><img src="../../assets/img/tg.svg" alt=""></a>
                            <?php } ?>
							<a href="../Actions/delete_doctor.php?id=<?php echo $user_data->doctor->get_id(); // // link to delite doctor ?>" class="button-text staff-block__button staff-block__button--delite"><p>Удалить</p> <img src="../../assets/img/delete.svg" alt=""></a>
						</div>
					</section>
				</section>
				<div class="staff-block__line"></div>
