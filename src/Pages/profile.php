				...
				<section class="user-about">
					...
					<div class="user-about__description">
                        ...
                        <?php if ($user->get_auth()){ //Button to edit the description (only visible if user is authenticated) ?>
						    <button class="user-about__description-button"><img src="../../assets/img/edit_gray.svg" alt="">Изменить</button>
                        <?php } ?>
					</div>
				</section>
                <!-- User's news -->
			...
			<section class="user-block__other">
				<section class="friends-block">
                    ...
                    <div class="friends-block__header">
                        ...
                        <a href="search_users.php" class="friends-block__header-button"><img src="../../assets/img/search.svg" alt=""></a>
                    </div>
                    <!-- Friends swiper -->
				...
				<section class="user-block__staff">
					...
					<div class="user-block__coach">
                        ...
                        <?php }else if($user->get_auth()){ // else print button to search users ?>
                            <a href="search_users.php" class="user-block__staff-button user-block__staff-button--add"><img src="../../assets/img/add_black.svg" alt=""></a>
                        <?php } ?>
					</div>
                    <!-- Doctor info -->
				...
				<section class="user-block__buttons">
                    ...
                    if ($user->get_auth()){ ?>
                        <?php if ($user->set_program($conn)){ // Display link to 'My Program' if available ?>
                            <a href="my_program.php" class="button-text user-block__button">Моя программа<img src="../../assets/img/my_programm.svg" alt=""></a>
                        <?php } ?>
					    <a href="../../clear.php" class="button-text user-block__button-logout">Выйти <img src="../../assets/img/logout.svg" alt=""></a>
                    <?php } else if ($user->set_program($conn)) { // Display link to user's program ?>
                        <a href="my_program.php?user=<?php echo $user->get_id(); ?>" class="button-text user-block__button">Программа пользователя<img src="../../assets/img/my_programm.svg" alt=""></a>
                    <?php } ?>
				</section>
			</section>
		</div>
        ...
        <section class="popup-exercise popup-exercise--user-info">
			<section class="popup-exercise__content popup-exercise__content--user-info">
                ...
                <?php if ($user->get_auth()){ // if user is authenticated print edit bitton ?>
                    <button type="button" class="popup-user__edit-button"><img src="../../assets/img/edit_gray.svg" alt="">Изменить</button>
                <?php } ?>
			</section>
		</section>
